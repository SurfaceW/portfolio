    ...
    <main className="p-4 md:p-5 min-h-screen">
      ...
      <div className="w-full max-w-[800px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 auto-rows-fr">
          ...
          {/* Work Cards - Adjusted for better layout */}
