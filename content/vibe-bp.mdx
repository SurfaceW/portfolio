...
or you can use [OpenSpecs](https://github.com/Fission-AI/OpenSpec) similar tool to help organize specs in project context.

* PRD (FRD) files for production feature specification
* Tech Specs files for production tech-stack specification
* Release Logs files for iteration specific context
* SOP files for specific tasks and operations

## Tools to co-work

- `AI first IDE`: Cursor, VSCode, etc. for daily coding and development with AI
- `Cli`: Claude Code, Gemini Code, etc. for complex tasks and operations with AGENT.md
- `MCP` the leverages: more context and operations (actions) to external services and tools.
  - `Context7` for versioned SDK docs provided
  - knowledge-base for external services and tools (SOP extracting and organizing)
- `ClaudeSkill` leverages: progressively disclosure the capabilities of AI for SOPs and tasks.
