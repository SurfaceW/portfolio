---
title: 'AI Driven FrontEnd Development [WIP]'
...
* use multiple modal AI to generate code
  * example: use GPT to generate code based on the picture of the UI and the description of the UI
...
* RAG based pattern: work with RAG to retrieve the context of the code and generate code based on the context.
