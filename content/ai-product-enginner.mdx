...
- [Multi-Agent — Agentic Patterns (Veso Research)](https://veso.ai/research/agentic-patterns/multi-agent/) — orchestrator/workers, handoff chain, parallel fan-out, peer mesh; shared state over messaging; delegation with isolation; MCP, A2A, agent-as-tool
