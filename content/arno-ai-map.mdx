...
> Arno is crafting `eThink` app to let AI do the meta-thinking for daily thinking process and elaboration process.

### Daily QA

> Daily general QA task -> **Gemini Pro / GPT**, deep understanding and reasoning
...
> Augment x Cursor x Gemini-Cli (ClaudeCode / GeminiCli)
...
- image generation -> GPT / Nano Banana of Google
- video generation -> Sora / Grok's 6s mini video generation
- audio generation
- 3D generation
...
| ---------- | ------ | ----- | ---------------------------------- | ----------- |
| GPT        | Medium | 👍🏻     | General tasks                      |             |
| Gemini Pro | Fast   | 👍🏻♥️    | General tasks, with search context | expensive   |
| Claude     | Medium | 👍🏻💎    | Coding                             |             |


### AI Development Tools for Software Engineering

> so many instances of VSCode is running on my Mac, :cry:
...
| AntiGravity       | IDE                   | IDE plugins    | new and fresh starter                |
...
| ------------ | --------------- | ------------------------ | ----------- | ---------------------------------------------------- |
| OpenAI Altas | AI Browser      | AI browsing and context  | API         | 🔬 browser first assist                               |
...
| ChatGPT Research  / Agent Mode | Research & General Usages   | AutoRun tasks                          | 👍🏻    |
